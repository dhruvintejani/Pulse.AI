...
export const RECENT_CHATS: RecentChat[] = [
  { id: '1', title: 'Market Research Analysis', time: '2m ago', period: 'today' },
  { id: '2', title: 'React Architecture Review', time: '1h ago', period: 'today' },
  { id: '3', title: 'Content Strategy Draft', time: '3h ago', period: 'today' },
];

export const CHAT_HISTORY: RecentChat[] = [
  { id: '1', title: 'Market Research Analysis', time: '2m ago', period: 'today' },
  { id: '2', title: 'React Architecture', time: '1h ago', period: 'today' },
  { id: '3', title: 'Content Strategy', time: '3h ago', period: 'today' },
  { id: '4', title: 'Product Roadmap', time: '4h ago', period: 'today' },
  { id: '5', title: 'SEO Optimization Plan', time: '1d ago', period: 'yesterday' },
  { id: '6', title: 'Brand Voice Guide', time: '1d ago', period: 'yesterday' },
  { id: '7', title: 'Investor Pitch Deck', time: '1d ago', period: 'yesterday' },
];
